 ...
 * ```
 */
export type DeepValue<TObj extends object, TKey extends DeepKeyOf<TObj>> = DeepPick<
  TObj,
  TKey
> extends infer Picked extends object
...
type TraversePicked<
  ...
  Path extends DeepKeyOf<TPicked>,
> = Path extends `${infer KCur}.${infer KRest}`
